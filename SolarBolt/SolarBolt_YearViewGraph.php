<?php //SolarBolt_YearViewGraph.php
...
*/
function getYearView($res, $result, $tip, 
			$subtitle, $title, $link, $renderTo
) {
echo <<<_END
...
$(function () {
    ...
    $(document).ready(function() {
        chart = new Highcharts.Chart({
            ...
            tooltip: {
                formatter: function() {
                    return ''+ this.series.name + ': '+ this.y +' $tip';
                }
            },
            plotOptions: {
                column: {
	...
	<body>
		...
		<div id = "content">
			...
			<a class='link' href='?page=2'>
					Consumption</a> <bar> | </bar>
			<a class='link' href='?page=3'>
					Feed In Tariff Credit</a><bar> | </bar>
